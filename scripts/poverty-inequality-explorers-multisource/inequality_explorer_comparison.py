...
# This code creates the tsv file for the comparison inequality explorer in the inequality topic page, available [here](https://owid.cloud/admin/explorers/preview/inequality_comparison)
