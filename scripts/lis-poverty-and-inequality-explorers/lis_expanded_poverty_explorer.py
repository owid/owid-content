    ...
    for wel in range(len(welfare)):
        for eq in range(len(equivalence_scales)):
            ...
            for p in range(len(povlines_abs)):
                df_tables.loc[
                    j, "name"
                ] = f"${povlines_abs['dollars_text'][p]} a day - average shortfall"
                df_tables.loc[
                    j, "slug"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - total shortfall"
                df_tables.loc[
                    j, "slug"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - average shortfall"
                df_tables.loc[
                    j, "slug"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - income gap ratio"
                df_tables.loc[
                    j, "slug"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - poverty gap index"
                df_tables.loc[
                    j, "slug"
