...
for tab in range(len(tables)):
    ...
    for wel in range(len(welfare)):
        ...
        for p in range(len(povlines_abs)):
            ...
            df_tables.loc[
                j, "slug"
            ] = f"avg_shortfall_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}_{povlines_abs['cents'][p]}"
            df_tables.loc[
                j, "description"
            ] = f"The average shortfall from a poverty line of ${povlines_abs['dollars_text'][p]} (averaged across the population in poverty).{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
            df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
            df_tables.loc[j, "shortUnit"] = "$"
            df_tables.loc[j, "type"] = "Numeric"
            df_tables.loc[j, "colorScaleNumericBins"] = povlines_abs[
        ...
        for p in range(len(povlines_abs)):
            ...
            df_tables.loc[
                j, "slug"
            ] = f"income_gap_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}_{povlines_abs['cents'][p]}"
            df_tables.loc[
                j, "description"
            ] = f'The average shortfall from a poverty line of ${povlines_abs.dollars_text[p]} a day (averaged across the population in poverty) expressed as a share of the poverty line. This metric is sometimes called the "income gap ratio". It captures the depth of poverty in which those below the poverty line are living.{new_line}This is {welfare.technical_text[wel]}. {welfare.subtitle[wel]}{new_line}Household {welfare.welfare_type[wel]} {welfare.note_eq[wel]}'
            df_tables.loc[j, "unit"] = "%"
            df_tables.loc[j, "shortUnit"] = "%"
            df_tables.loc[j, "type"] = "Numeric"
        ...
        for pct in range(len(povlines_rel)):
            ...
            df_tables.loc[
                j, "slug"
            ] = f"total_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_tables.loc[
                j, "description"
        ...
        for pct in range(len(povlines_rel)):
            ...
            df_tables.loc[
                j, "slug"
            ] = f"avg_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_tables.loc[
                j, "description"
            ] = f"The average shortfall from a poverty line of of {povlines_rel['text'][pct]} disposable household income (averaged across the population in poverty).{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
            df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
            df_tables.loc[j, "shortUnit"] = "$"
            df_tables.loc[j, "type"] = "Numeric"
        ...
        for pct in range(len(povlines_rel)):
            ...
            df_tables.loc[
                j, "slug"
            ] = f"income_gap_ratio_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_tables.loc[
                j, "description"
        ...
        for pct in range(len(povlines_rel)):
            ...
            df_tables.loc[
                j, "slug"
            ] = f"poverty_gap_index_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_tables.loc[
                j, "description"
...
for tab in range(len(tables)):
    for wel in range(len(welfare)):
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"{povlines_abs['title_total_shortfall'][p]} ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"total_shortfall_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}_{povlines_abs.cents[p]}"
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"{povlines_abs['title_avg_shortfall'][p]} ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"avg_shortfall_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}_{povlines_abs['cents'][p]}"
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"{povlines_abs['title_income_gap_ratio'][p]} ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"income_gap_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}_{povlines_abs['cents'][p]}"
            df_graphers.loc[
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"Poverty gap index at ${povlines_abs['dollars_text'][p]} a day ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"poverty_gap_index_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}_{povlines_abs['cents'][p]}"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Total shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"total_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_graphers.loc[j, "Metric Dropdown"] = "Total shortfall from poverty line"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Average shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"avg_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_graphers.loc[j, "Metric Dropdown"] = "Average shortfall ($)"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Average shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} (as a share of the poverty line) ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"income_gap_ratio_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_graphers.loc[
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Poverty gap index at {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"poverty_gap_index_{povlines_rel['slug_suffix'][pct]}_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
            df_graphers.loc[j, "Metric Dropdown"] = "Poverty gap index"
