    ...
    for wel in range(len(welfare)):
        for eq in range(len(equivalence_scales)):
            ...
            for p in range(len(povlines_abs)):
                ...
                df_tables.loc[
                    j, "description"
                ] = f"The average shortfall from a poverty line of ${povlines_abs['dollars_text'][p]} (averaged across the population in poverty).{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {equivalence_scales['note'][eq]}"
                df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
                df_tables.loc[j, "shortUnit"] = "$"
                df_tables.loc[j, "type"] = "Numeric"
                df_tables.loc[j, "colorScaleNumericBins"] = povlines_abs[
            ...
            for p in range(len(povlines_abs)):
                ...
                df_tables.loc[
                    j, "description"
                ] = f'The average shortfall from a poverty line of ${povlines_abs.dollars_text[p]} a day (averaged across the population in poverty) expressed as a share of the poverty line. This metric is sometimes called the "income gap ratio". It captures the depth of poverty in which those below the poverty line are living.{new_line}This is {welfare.technical_text[wel]}. {welfare.subtitle[wel]}{new_line}Household {welfare.welfare_type[wel]} {equivalence_scales.note[eq]}'
                df_tables.loc[j, "unit"] = "%"
                df_tables.loc[j, "shortUnit"] = "%"
                df_tables.loc[j, "type"] = "Numeric"
                df_tables.loc[
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - total number of people below poverty line ({equivalence_scales['text'][eq]})"
                df_tables.loc[
                    j, "slug"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - total shortfall ({equivalence_scales['text'][eq]})"
                df_tables.loc[
                    j, "slug"
                ] = f"total_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_tables.loc[
                    j, "description"
                ] = f"The total shortfall from a poverty line of {povlines_rel['text'][pct]} disposable household income. This is the amount of money that would be theoretically needed to lift the {welfare['welfare_type'][wel]} of all people in poverty up to the poverty line. However this is not a measure of the actual cost of eliminating poverty, since it does not take into account the costs involved in making the necessary transfers nor any changes in behaviour they would bring about.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {equivalence_scales['note'][eq]}"
                df_tables.loc[j, "unit"] = np.nan
                df_tables.loc[j, "shortUnit"] = np.nan
                df_tables.loc[j, "type"] = "Numeric"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - average shortfall ({equivalence_scales['text'][eq]})"
                df_tables.loc[
                    j, "slug"
                ] = f"avg_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_tables.loc[
                    j, "description"
                ] = f"The average shortfall from a poverty line of of {povlines_rel['text'][pct]} disposable household income (averaged across the population in poverty).{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {equivalence_scales['note'][eq]}"
                df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
                df_tables.loc[j, "shortUnit"] = "$"
                df_tables.loc[j, "type"] = "Numeric"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - income gap ratio ({equivalence_scales['text'][eq]})"
                df_tables.loc[
                    j, "slug"
                ] = f"income_gap_ratio_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_tables.loc[
                    j, "description"
                ] = f'The average shortfall from a poverty line of of {povlines_rel.text[pct]} disposable household income (averaged across the population in poverty) expressed as a share of the poverty line. This metric is sometimes called the "income gap ratio". It captures the depth of poverty in which those below the poverty line are living.{new_line}This is {welfare.technical_text[wel]}. {welfare.subtitle[wel]}{new_line}Household {welfare.welfare_type[wel]} {equivalence_scales.note[eq]}'
                df_tables.loc[j, "unit"] = "%"
                df_tables.loc[j, "shortUnit"] = "%"
                df_tables.loc[j, "type"] = "Numeric"
            ...
            for pct in range(len(povlines_rel)):
                df_tables.loc[
                    j, "name"
                ] = f"{povlines_rel['percent'][pct]} of median DHI - poverty gap index ({equivalence_scales['text'][eq]})"
                df_tables.loc[
                    j, "slug"
                ] = f"poverty_gap_index_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_tables.loc[
                    j, "description"
                ] = f"The poverty gap index calculated at a poverty line of {povlines_rel['text'][pct]} disposable household income. The poverty gap index is a measure that reflects both the depth and prevalence of poverty. It is defined as the mean shortfall of the total population from the poverty line counting the non-poor as having zero shortfall and expressed as a percentage of the poverty line. It is worth unpacking that definition a little. For those below the poverty line, the shortfall corresponds to the amount of money required in order to reach the poverty line. For those at or above the poverty line, the shortfall is counted as zero. The average shortfall is then calculated across the total population – both poor and non-poor – and then expressed as a share of the poverty line. Unlike the more commonly-used metric of the headcount ratio, the poverty gap index is thus sensitive not only to whether a person’s income falls below the poverty line or not, but also by how much – i.e. to the depth of poverty they experience.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {equivalence_scales['note'][eq]}"
                df_tables.loc[j, "unit"] = "%"
                df_tables.loc[j, "shortUnit"] = "%"
                df_tables.loc[j, "type"] = "Numeric"
    ...
    for wel in range(len(welfare)):
        for eq in range(len(equivalence_scales)):
            ...
            for p in range(len(povlines_abs)):
                df_graphers.loc[
                    j, "title"
                ] = f"{povlines_abs['title_total_shortfall'][p]} ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"total_shortfall_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}_{povlines_abs.cents[p]}"
                df_graphers.loc[
            ...
            for p in range(len(povlines_abs)):
                df_graphers.loc[
                    j, "title"
                ] = f"{povlines_abs['title_avg_shortfall'][p]} ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"avg_shortfall_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}_{povlines_abs['cents'][p]}"
            ...
            for p in range(len(povlines_abs)):
                df_graphers.loc[
                    j, "title"
                ] = f"{povlines_abs['title_income_gap_ratio'][p]} ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"income_gap_ratio_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}_{povlines_abs['cents'][p]}"
                df_graphers.loc[
            ...
            for p in range(len(povlines_abs)):
                df_graphers.loc[
                    j, "title"
                ] = f"Poverty gap index at ${povlines_abs['dollars_text'][p]} a day ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"poverty_gap_index_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}_{povlines_abs['cents'][p]}"
            ...
            for pct in range(len(povlines_rel)):
                df_graphers.loc[
                    j, "title"
                ] = f"Total shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"total_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_graphers.loc[
                ...
                df_graphers.loc[
                    j, "subtitle"
                ] = f"This is the amount of money that would be theoretically needed to lift the incomes of all people in poverty up to {povlines_rel.text[pct]} disposable household income. {welfare['subtitle'][wel]}"
                df_graphers.loc[
                    j, "note"
                ] = f"This data is measured in international-$ at 2017 prices to account for inflation and differences in the cost of living between countries."
                df_graphers.loc[j, "type"] = np.nan
            ...
            for pct in range(len(povlines_rel)):
                df_graphers.loc[
                    j, "title"
                ] = f"Average shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"avg_shortfall_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_graphers.loc[j, "Metric Dropdown"] = "Average shortfall ($)"
                ...
                df_graphers.loc[
                    j, "subtitle"
                ] = f"This is the amount of money that would be theoretically needed to lift the incomes of all people in poverty up to {povlines_rel['text'][pct]} disposable household income, averaged across the population in poverty. {welfare['subtitle'][wel]}"
                df_graphers.loc[
                    j, "note"
                ] = f"This data is measured in international-$ at 2017 prices to account for inflation and differences in the cost of living between countries."
                df_graphers.loc[j, "type"] = np.nan
            ...
            for pct in range(len(povlines_rel)):
                df_graphers.loc[
                    j, "title"
                ] = f"Average shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} (as a share of the poverty line) ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"income_gap_ratio_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_graphers.loc[
                ...
                df_graphers.loc[
                    j, "subtitle"
                ] = f'This is the average shortfall expressed as a share of the poverty line, sometimes called the "income gap ratio". It captures the depth of poverty in which those below {povlines_rel.text[pct]} disposable household income are living. {welfare.subtitle[wel]}'
                df_graphers.loc[
                    j, "note"
                ] = f"This data is measured in international-$ at 2017 prices to account for inflation and differences in the cost of living between countries."
                df_graphers.loc[j, "type"] = np.nan
            ...
            for pct in range(len(povlines_rel)):
                df_graphers.loc[
                    j, "title"
                ] = f"Poverty gap index at {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, {equivalence_scales['text'][eq]})"
                df_graphers.loc[
                    j, "ySlugs"
                ] = f"poverty_gap_index_{povlines_rel['slug_suffix'][pct]}_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
                df_graphers.loc[j, "Metric Dropdown"] = "Poverty gap index"
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"{povlines_abs['title_total_shortfall'][p]} ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"{povlines_abs['title_avg_shortfall'][p]} ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"{povlines_abs['title_income_gap_ratio'][p]} ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for p in range(len(povlines_abs)):
            df_graphers.loc[
                j, "title"
            ] = f"Poverty gap index at ${povlines_abs['dollars_text'][p]} a day ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Total shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Average shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Average shortfall from a poverty line of {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} (as a share of the poverty line) ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
        ...
        for pct in range(len(povlines_rel)):
            df_graphers.loc[
                j, "title"
            ] = f"Poverty gap index at {povlines_rel['text'][pct]} {welfare['welfare_type'][wel]} ({welfare['title'][wel].capitalize()}, equivalized vs. per capita)"
            df_graphers.loc[
                j, "ySlugs"
