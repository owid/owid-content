...
for tab in range(len(tables)):
    ...
    for wel in range(len(welfare)):
        ...
        df_tables.loc[
            j, "name"
        ] = f"Gini coefficient ({welfare['technical_text'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_tables.loc[
            j, "slug"
        ] = f"gini_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        df_tables.loc[
            j, "description"
        ] = f"The Gini coefficient is a measure of the inequality of the {welfare['welfare_type'][wel]} distribution in a population. Higher values indicate a higher level of inequality.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
        ...
        df_tables.loc[
            j, "name"
        ] = f"{welfare['welfare_type'][wel].capitalize()} share of the richest 10% ({welfare['technical_text'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_tables.loc[
            j, "slug"
        ] = f"share_p90_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        df_tables.loc[
            j, "description"
        ] = f"This is the {welfare['welfare_type'][wel]} of the richest 10% as a share of total {welfare['welfare_type'][wel]}.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
        ...
        df_tables.loc[
            j, "name"
        ] = f"P90/P10 ratio ({welfare['technical_text'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_tables.loc[
            j, "slug"
        ] = f"p90_p10_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        df_tables.loc[
            j, "description"
        ] = f"P90 is the the level of {welfare['welfare_type'][wel]} below which 90% of the population lives. P10 is the level of {welfare['welfare_type'][wel]} below which 10% of the population lives. This variable gives the ratio of the two. It is a measure of inequality that indicates the gap between the richest and poorest tenth of the population. It tells you how many times richer someone just in the the poorest tenth would need to be in order to be counted in the richest tenth.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
        df_tables.loc[j, "unit"] = np.nan
        df_tables.loc[j, "shortUnit"] = np.nan
        df_tables.loc[j, "type"] = "Numeric"
        ...
        df_tables.loc[
            j, "name"
        ] = f"P90/P50 ratio ({welfare['technical_text'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_tables.loc[
            j, "slug"
        ] = f"p90_p50_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        df_tables.loc[
            j, "description"
        ] = f"P90 is the the level of {welfare['welfare_type'][wel]} above which 10% of the population lives. P50 is the median – the level of {welfare['welfare_type'][wel]} below which 50% of the population lives. This variable gives the ratio of the two. It is a measure of inequality within the top half of the distribution. It tells you how many times richer someone in the middle of the distribution would need to be in order to be counted in the richest tenth.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
        df_tables.loc[j, "unit"] = np.nan
        df_tables.loc[j, "shortUnit"] = np.nan
        df_tables.loc[j, "type"] = "Numeric"
        ...
        df_tables.loc[
            j, "name"
        ] = f"P50/P10 ratio ({welfare['technical_text'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_tables.loc[
            j, "slug"
        ] = f"p50_p10_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        df_tables.loc[
            j, "description"
        ] = f"P50 is the median – the level of {welfare['welfare_type'][wel]} below which 50% of the population lives. P10 is the the level of {welfare['welfare_type'][wel]} below which 10% of the population lives. This variable gives the ratio of the two. It is a measure of inequality within the bottom half of the distribution. It tells you how many times richer someone just in the the poorest tenth would need to be in order to be reach the median.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
        df_tables.loc[j, "unit"] = np.nan
        df_tables.loc[j, "shortUnit"] = np.nan
        df_tables.loc[j, "type"] = "Numeric"
        ...
        df_tables.loc[
            j, "name"
        ] = f"Palma ratio ({welfare['technical_text'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_tables.loc[
            j, "slug"
        ] = f"palma_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        df_tables.loc[
            j, "description"
        ] = f"The Palma ratio is a measure of inequality: it is the share of total {welfare['welfare_type'][wel]} of the top 10% divided by the share of the bottom 40%.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}Household {welfare['welfare_type'][wel]} {welfare['note_eq'][wel]}"
        df_tables.loc[j, "unit"] = np.nan
        df_tables.loc[j, "shortUnit"] = np.nan
        df_tables.loc[j, "type"] = "Numeric"
...
for tab in range(len(tables)):
    for wel in range(len(welfare)):
        ...
        df_graphers.loc[
            j, "title"
        ] = f"{welfare['welfare_type'][wel].capitalize()} inequality: Gini coefficient ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_graphers.loc[
            j, "ySlugs"
        ] = f"gini_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        ...
        df_graphers.loc[
            j, "title"
        ] = f"{welfare['welfare_type'][wel].capitalize()} share of the top 10% ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_graphers.loc[
            j, "ySlugs"
        ] = f"share_p90_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        ...
        df_graphers.loc[
            j, "title"
        ] = f"{welfare['welfare_type'][wel].capitalize()} inequality: P90/P10 ratio ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_graphers.loc[
            j, "ySlugs"
        ] = f"p90_p10_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        ...
        df_graphers.loc[
            j, "title"
        ] = f"{welfare['welfare_type'][wel].capitalize()} inequality: P90/P50 ratio ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_graphers.loc[
            j, "ySlugs"
        ] = f"p90_p50_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        ...
        df_graphers.loc[
            j, "title"
        ] = f"{welfare['welfare_type'][wel].capitalize()} inequality: P50/P10 ratio ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_graphers.loc[
            j, "ySlugs"
        ] = f"p50_p10_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
        ...
        df_graphers.loc[
            j, "title"
        ] = f"{welfare['welfare_type'][wel].capitalize()} inequality: Palma ratio ({welfare['title'][wel].capitalize()}, {welfare['text_eq'][wel]})"
        df_graphers.loc[
            j, "ySlugs"
        ] = f"palma_ratio_{welfare['slug_welfare'][wel]}_{welfare['slug_eq'][wel]}"
