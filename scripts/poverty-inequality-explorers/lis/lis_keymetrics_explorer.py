...
for tab in range(len(tables)):
    ...
    for wel in range(len(welfare)):
        for eq in range(len(equivalence_scales)):
            ...
            df_tables.loc[
                j, "description"
            ] = f"This is the level of {welfare['welfare_type'][wel]} below which 50% of the population falls.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}{equivalence_scales['note'][eq]}"
            df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
            df_tables.loc[j, "shortUnit"] = "$"
            df_tables.loc[j, "type"] = "Numeric"
            ...
            df_tables.loc[
                j, "description"
            ] = f"The level of {welfare['welfare_type'][wel]} below which 10% of the population falls.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}{equivalence_scales['note'][eq]}"
            df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
            df_tables.loc[j, "shortUnit"] = "$"
            df_tables.loc[j, "type"] = "Numeric"
            df_tables.loc[
            ...
            df_tables.loc[
                j, "description"
            ] = f"The level of {welfare['welfare_type'][wel]} below which 90% of the population falls.{new_line}This is {welfare['technical_text'][wel]}. {welfare['subtitle'][wel]}{new_line}{equivalence_scales['note'][eq]}"
            df_tables.loc[j, "unit"] = "international-$ in 2017 prices"
            df_tables.loc[j, "shortUnit"] = "$"
            df_tables.loc[j, "type"] = "Numeric"
            df_tables.loc[
...
for tab in range(len(tables)):
    for wel in range(len(welfare)):
        for eq in range(len(equivalence_scales)):
            ...
            df_graphers.loc[
                j, "title"
            ] = f"Threshold {welfare['welfare_type'][wel]} marking the poorest decile ({welfare['title'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"thr_p10_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
            df_graphers.loc[
            ...
            df_graphers.loc[
                j, "title"
            ] = f"Threshold {welfare['welfare_type'][wel]} marking the richest decile ({welfare['title'][wel]})"
            df_graphers.loc[
                j, "ySlugs"
            ] = f"thr_p90_{welfare['slug'][wel]}_{equivalence_scales['slug'][eq]}"
            df_graphers.loc[
        ...
        df_graphers.loc[
            j, "title"
        ] = f"Threshold {welfare['welfare_type'][wel]} marking the poorest decile ({welfare['title'][wel]}, equivalized vs. per capita)"
        df_graphers.loc[
            j, "ySlugs"
        ...
        df_graphers.loc[
            j, "title"
        ] = f"Threshold {welfare['welfare_type'][wel]} marking the richest decile ({welfare['title'][wel]}, equivalized vs. per capita)"
        df_graphers.loc[
            j, "ySlugs"
